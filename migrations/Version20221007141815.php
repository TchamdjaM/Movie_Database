 ...
 */
final class Version20221007141815 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE films_genres (films_id INT NOT NULL, genres_id INT NOT NULL, INDEX IDX_1FBF6EAF6A3B2603 (genres_id), INDEX IDX_1FBF6EAF939610EE (films_id), PRIMARY KEY(films_id, genres_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
